...
describe('Test daemon functionality', () => {
  ...
  test('Test daemon initialization [3]', (done) => {
    ...
    const daemon = new Daemon(daemonsCopy);
    const expected = '[{"error":true,"response":"Unauthorized RPC access. Invalid RPC username or password","instance":{"host":"127.0.0.1","port":"8332","username":"foundation","password":"foundation","index":0},"data":"{\\"error\\":null,\\"result\\":null,\\"instance\\":\\"nocktest\\"}"}]';
    daemon.checkInstances((error, response) => {
